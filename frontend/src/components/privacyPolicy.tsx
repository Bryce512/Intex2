            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <span className="question">April 07, 2025</span>
                </span>
              </span>
            </strong>
          </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <span style={{ color: "rgb(0, 58, 250)" }}>
                    <span className="question">
                      <a
                        href="https://icy-sky-018ec221e.6.azurestaticapps.net/"
                        target="_blank"
              ...
              <span style={{ fontSize: 15 }}>
                <span style={{ color: "rgb(127, 127, 127)" }}>
                  <span data-custom-class="body_text">
                    ...
                    <span className="question">lukewc02@byu.edu</span>.
                  </span>
                </span>
              </span>
            </div>
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  ...
                  visiting{" "}
                  <span style={{ color: "rgb(0, 58, 250)" }}>
                    <span className="question">coolmathgames.com</span>
                  </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    ...
                    <span className="question">Venmo</span>
                    <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                      <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                        <span data-custom-class="body_text">
                          <span
